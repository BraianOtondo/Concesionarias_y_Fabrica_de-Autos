use automotriz;
DELIMITER $$
create procedure generarAutomoviles(in _id_modelo int,in id_pedido int, in _cantidad int,in precio decimal)begin
...
-- declare NumeroDesde int default 1000 ;
-- declare NumeroHasta int default 9999;
simple_loop: LOOP
set i=i+1;
 IF i=_cantidad THEN
            LEAVE simple_loop;
    ...
    insert into automovil values(_nro_chasis,precio,_id_modelo,id_pedido,id_linea_);
